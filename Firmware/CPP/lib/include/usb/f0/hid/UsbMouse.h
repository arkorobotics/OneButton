...
namespace stm32plus {
  ...
  /**
   * The UsbMouse class handles all the interaction with the USB peripheral. You are provided with one
   ...
   *   typedef UsbMouse<MyUsbConfiguration> MyUsb;
   *
  ...
  class UsbMouse : public Features... {
    ...
    public:
      ...
      static const uint8_t _reportDescriptor[50];
  ...
  template<class TConfiguration,class... Features>
  const uint8_t UsbMouse<TConfiguration,Features...>::_reportDescriptor[50] = {
  ...
  template<class TConfiguration,class... Features>
  const uint8_t UsbMouse<TConfiguration,Features...>::_deviceDescriptor[18]={
    sizeof(UsbMouse<TConfiguration,Features...>::_deviceDescriptor),  // bLength
  ...
  template<class TConfiguration,class... Features>
  const uint8_t UsbMouse<TConfiguration,Features...>::_configurationDescriptor[41]={

    // configuration descriptor header

    0x09,                           // bLength: Configuration Descriptor size
    USB_DESC_TYPE_CONFIGURATION,    // bDescriptorType: Configuration
    sizeof(UsbMouse<TConfiguration,Features...>::_configurationDescriptor),0,  // wTotalLength
    0x01,                           // bNumInterfaces
    ...
    sizeof(UsbMouse<TConfiguration,Features...>::_reportDescriptor),0, // wItemLength: Total length of Report descriptor
  ...
  template<class TConfiguration,class... Features>
  const uint8_t UsbMouse<TConfiguration,Features...>::_hidDescriptor[9]={
    0x09,                           // bLength: CUSTOM_HID Descriptor size
    USB_DESC_TYPE_HID_DESCRIPTOR,   // bDescriptorType: CUSTOM_HID
    0x11,0x01,                      // bcdHID HID Class Spec release number (1.11)
    0x00,                           // bCountryCode: Hardware target country
  ...
  template<class TConfiguration,class... Features>
  const uint8_t UsbMouse<TConfiguration,Features...>::_langIdDescriptor[4] = {
    sizeof(UsbMouse<TConfiguration,Features...>::_langIdDescriptor),
  ...
  template<class TConfiguration,class... Features>
  inline UsbMouse<TConfiguration,Features...>::UsbMouse() {
    ...
    usbInterrupt.UsbInterruptEventSender.insertSubscriber(
        UsbInterruptEventSourceSlot::bind(this,&UsbMouse<TConfiguration,Features...>::onInterrupt));
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::stop() {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::setInterruptMask() const {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::reset() const {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::clearInterrupts() const {
    USBR->ISTR=0;
  }
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::start() {
  ...
  template<class TConfiguration,class... Features>
  inline bool UsbMouse<TConfiguration,Features...>::sendReport(const void *report,uint16_t length) {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::setAddress(uint8_t address) {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::openControlEndpoints() {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::closeControlEndpoints() {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::openRxEndpoint(volatile uint16_t *reg,uint8_t addr,uint16_t type,uint16_t pmaAddress,uint16_t maxPacketSize) const {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::openTxEndpoint(volatile uint16_t *reg,uint8_t addr,uint16_t type,uint16_t pmaAddress) const {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::openDeviceEndpoints() const {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::closeDeviceEndpoints() const {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::closeRxEndpoint(volatile uint16_t *reg) const {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::closeTxEndpoint(volatile uint16_t *reg) const {
  ...
  template<class TConfiguration,class... Features>
  inline uint16_t UsbMouse<TConfiguration,Features...>::setRxStatus(uint16_t reg,uint16_t status) const {
  ...
  template<class TConfiguration,class... Features>
  inline uint16_t UsbMouse<TConfiguration,Features...>::setTxStatus(uint16_t reg,uint16_t status) const {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::controlEndpointError() const {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::setRxEndpointStatus(volatile uint16_t *epreg,uint16_t status) const {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::setTxEndpointStatus(volatile uint16_t *epreg,uint16_t status) const {
  ...
  template<class TConfiguration,class... Features>
  inline uint16_t UsbMouse<TConfiguration,Features...>::getRxEndpointStatus(volatile uint16_t *epreg) const  {
  ...
  template<class TConfiguration,class... Features>
  inline uint16_t UsbMouse<TConfiguration,Features...>::getTxEndpointStatus(volatile uint16_t *epreg) const {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::handleControlOutTransfer() {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::handleControlSetupOutTransfer() {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::handleDeviceRequest(const UsbSetupHeader& header) {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::handleGetDescriptor(const UsbSetupHeader& header) {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::handleGetDescriptorString(const UsbSetupHeader& header,uint8_t*& dataToSend,uint16_t& length) {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::handleSetAddress(const UsbSetupHeader& header) {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::handleSetConfig(const UsbSetupHeader& header) {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::handleGetConfig(const UsbSetupHeader& header) {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::handleGetStatus() {
    ...
    if(_deviceState==DeviceStateType::ADDRESSED || _deviceState==DeviceStateType::CONFIGURED) {
      ...
      if(std::is_base_of<UsbSelfPoweredFeature,UsbMouse<TConfiguration,Features...>>::value)
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::handleSetFeature(const UsbSetupHeader& header) {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::handleClearFeature(const UsbSetupHeader& header) {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::sendControlData(const void *data,uint16_t length) {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::sendControlZeroLengthPacket() {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::sendData(
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::continueSendData(uint8_t endpointIndex) {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::handleInterfaceRequest(const UsbSetupHeader& header) {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::handleSetup(const UsbSetupHeader& header) {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::handleClassSetup(const UsbSetupHeader& header) {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::handleStandardSetup(const UsbSetupHeader& header) {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::handleEndpointRequest(const UsbSetupHeader& header) {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::stallEndpoint(uint8_t epAddr) const {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::unstallEndpoint(uint8_t epAddr) const {
  ...
  template<class TConfiguration,class... Features>
  inline bool UsbMouse<TConfiguration,Features...>::isStalled(uint8_t epAddr) const {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::handleControlDataOutTransfer() {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::copyReceivedData(void *dest,uint32_t src,uint16_t byteCount) const {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::handleControlInTransfer() {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::onInterrupt() {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::onCorrectTransfer() {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::handleEndpointInTransfer(volatile uint16_t *reg,uint8_t endpointIndex) {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::handleEndpointOutTransfer(volatile uint16_t *reg,uint8_t endpointIndex) {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::onReset() {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::onPacketMemoryOverUnderFlow() const {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::onError() const {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::onWakeup() {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::onSuspend() {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::onStartOfFrame() const {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::onExpectedStartOfFrame() const {
  ...
  template<class TConfiguration,class... Features>
  inline void UsbMouse<TConfiguration,Features...>::setDeviceState(DeviceStateType newState) {
  ...
  template<class TConfiguration,class... Features>
  inline typename UsbMouse<TConfiguration,Features...>::DeviceStateType UsbMouse<TConfiguration,Features...>::getDeviceState() const {
    return _deviceState;
  }
}
